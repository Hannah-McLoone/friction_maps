...
"""
vaues gas no attribute country road values
...
file_name='part-00017-d84517a6-f7b3-48eb-8ec2-e27684978d01-c000.zstd.parquet' #35 for uk or 01
file_path = remote_directory + '/' + file_name
remote_file = sftp.file(file_path, 'rb')
