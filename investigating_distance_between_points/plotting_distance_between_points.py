...
lambda_val = 35  # rate parameter for exponential distribution
total = 10000   # number of trials per resolution

if log_display:
    resolutions = np.logspace(-3, 0, num=20)  # From 0.001 to 1 (log scale)
else:
    resolutions = np.linspace(0.001, 1, num=20)  # Linear spacing from 0.001 to 1
